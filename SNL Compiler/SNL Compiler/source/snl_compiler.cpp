...
//    std::string wzl_path = "E:/snl_qt/SNL-Compiler/SNL Compiler/SNL Compiler/test case/simple/C1.TXT";
//    std::string wzl_prod_path = "E:/snl_qt/SNL-Compiler/SNL Compiler/SNL Compiler/produciton/productions_pptt.txt";
